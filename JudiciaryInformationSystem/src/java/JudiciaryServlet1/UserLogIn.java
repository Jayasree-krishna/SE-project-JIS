...
public class UserLogIn extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getParameter("login")!=null){
            ...
            {
                if((LogInCheck.LoginChecking(name, pwd,type)))
                {
                    RequestDispatcher rd=request.getRequestDispatcher("LawyerActionPage.jsp");
            ...
            if(type.matches("Defendant")==true)
            {
                if((LogInCheck.LoginChecking(name, pwd,type)))
                {
                    ...
                    RequestDispatcher rd=request.getRequestDispatcher("DefendantHome.jsp");
                    rd.forward(request, response);
                }
                else{
                    JOptionPane.showMessageDialog(null, "New User has to SignUp");
            ...
            if(type.matches("Judge")==true)
            {
                if((LogInCheck.LoginChecking(name, pwd,type)))
                {
                    ...
                    RequestDispatcher rd=request.getRequestDispatcher("JudgeHome.jsp");
                    rd.forward(request, response);
                }
                else{
                    JOptionPane.showMessageDialog(null, "New User has to SignUp");
